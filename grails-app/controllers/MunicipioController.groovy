...
class MunicipioController {
    static municipioDoc = ['895': 'Amacuzac', '896': 'Atlatlahucan', '897': 'Axochiapan', '898': 'Ayala', '899': 'Coatlán del Río', '900': 'Cuautla', '901': 'Cuernavaca', '902' : 'Emiliano Zapata', '903': 'Huitzilac',]
    ...
    def listMunicipio(){
         def listMunicipio = Municipio.findAll("From Municipio where estado=17")
        
        render(model:[listMunicipio:listMunicipio])
