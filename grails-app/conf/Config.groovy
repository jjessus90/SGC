...
log4j = {
    ...
    def logFile=logDirectory+'/specialLog.log'
    println catalinaBase
    println logDirectory
    println logFile

  appenders {
    rollingFile name:'specialLog', file: logFile
  }
...
// Added by the Spring Security Core plugin:
grails.plugins.springsecurity.userLookup.userDomainClassName = 'UsuarioSistema'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'RolePeople'
...
grails {
    mail {
      host = "smtp.gmail.com"
      port = 465
      username = "soporte.correspondencia@gmail.com"
      password = "cggd2013"
