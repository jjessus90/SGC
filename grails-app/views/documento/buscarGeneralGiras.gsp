...
<html>
  ...
  <!-- Div fechas -->
                ...
                <fieldset class="buttons">
                    <g:actionSubmit class="save" action="consultaGeneralGiras" value="Consultar" />
                    <g:actionSubmit class="excel" action="generarexcelconsultaGiras" value="Generar Excel" /> 
                </fieldset>
            </g:form>
            ...
            <div class="pagination">
                <g:if test="${documentoInstanceList}">
                    <g:paginate controller="documento" action="consultaGeneralGiras" params="['paginacion':'si','fechaInicio':params.fechaInicio2 ,'fechaFin':params.fechaFin2, folio:params.folio, remitente:params.remitente, asunto:params.asunto]"  total="${documentoInstanceTotal}" />
                </g:if>
            </div>
        </div>
    </body>
