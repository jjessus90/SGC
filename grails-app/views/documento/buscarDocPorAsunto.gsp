...
<html>
    ...
    <body>
        ...
        <div id="list-documento" class="content scaffold-list" role="main">
            <h1>Buscar Documentos por Asunto</h1>
  ...
  <!-- Div fechas -->
                <table>
                    <tr>
                        <td>Palabra a buscar:</td>
                        <td><g:textField name="cadena" value=""  /></td>
                    </tr>
                ...
                <fieldset class="buttons">
                    <g:actionSubmit class="save" action="consultaDocPorAsunto" value="Consultar" />
                </fieldset>
            </g:form>

            <g:if test="${cadena}">
                <li class="fieldcontain">
                    <span id="fechaSolicitud-label" class="property-label"><g:message code="documento.fechaCaptura.label" default="Palabra buscada:" /></span>

                    <span class="property-value" ><b>${cadena}</b></span>
