...
<html>
	...
	<body>
		...
		<div id="edit-documento" class="content scaffold-edit" role="main">
			...
			<g:form method="post" action="updateDocumentoCreado" name="documento">
				<g:hiddenField name="id" value="${documentoInstance?.id}" />
				<g:hiddenField name="version" value="${documentoInstance?.version}" />
				<fieldset class="form">
					<g:render template="formDCCA"/>
				</fieldset>
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="updateDocumentoCreado" value="${message(code: 'default.button.update.label', default: 'Update')}" />
