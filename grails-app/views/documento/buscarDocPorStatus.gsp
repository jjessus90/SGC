...
<html>
    ...
    <body>
        ...
        <div id="list-documento" class="content scaffold-list" role="main">
            <h1>Buscar Documentos por Status</h1>
  ...
  <!-- Div fechas -->
                <table>
                    <tr>
                        <td>Status:</td>
                        <td>
                <g:select name="status" from="${['Creado', 'Turnado', 'Con Seguimiento', 'Terminado']}"  />
                ...
                <fieldset class="buttons">
                    <g:actionSubmit class="save" action="consultaDocPorStatus" value="Consultar" />
                </fieldset>
            </g:form>

            <g:if test="${status}">
                <li class="fieldcontain">
                    <span id="fechaSolicitud-label" class="property-label"><g:message code="documento.fechaCaptura.label" default="Status buscado:" /></span>

                    <span class="property-value" ><b>${status}</b></span>
