...
<body>
  ...
  <div id="create-documento" class="content scaffold-create" role="main">
    ...
    <g:form action="saveDCCA" name="createDoc" >
      <fieldset class="form">
        <g:render template="formDCCA"/>
      </fieldset>
      <fieldset class="buttons">
        <g:submitButton name="create" class="save" onclick="asignarValores()" value="${message(code: 'default.button.create.label', default: 'Create')}"/>
      </fieldset>
    </g:form>
  </div>
</body>
