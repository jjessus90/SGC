                ...
                <fieldset class="form">
                    ...
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                            ...
                            <div style="width:300px" >
                                ...
                                <table>
                                    ...
                                    <tr class="prop">
                                        ...
                                        <td valign="top" class="value ${hasErrors(bean: seguimientoInstance, field: 'seguimiento', 'errors')}">
                                        <g:textArea name="seguimiento" required="" value="" id="resizable" />    
                            ...
                            <div class="buttons">
                                <span class="button"><g:actionSubmit value="Agregar" action="saveSeguimientoTurnado"  class="save" /></span>
                                <g:if test="${documentoInstance}">
                            <g:link  action="showDocTurnado" id="${documentoInstance?.id}" params="['id': documentoInstance?.id]" title="Click mostrar detalle general del documento" controller="documento"> <img src="${resource(dir:'images/skin',file:'editDocument.png')}" width="" height="" />    </g:link>
                            ...
                            <table style=" font-size: 11px;">
                                <thead>
                                    <tr>
                                        ...
                                        <g:sortableColumn property="nombre" title="${message(code: 'turnado.nombre.label', default: 'Seguimiento')}" />
                                ...
                                <tbody>
                                    <g:each in="${seguimientoInstance}" status="i" var="seguimiento">
                                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                            ...
                                            <td>${seguimientoInstance[i]?.documento?.folio?.encodeAsHTML()}</td>
                                            ...
                                            <g:link  action="editTurnado" id="${seguimientoInstance[i].id}" params="['documento.id': documentoInstance?.id, 'id': seguimientoInstance[i]?.id]" controller="seguimiento"> <img src="${resource(dir:'images',file:'editCat.png')}" width="" height="" />    </g:link>
                                            </td>
                                            <td>    

                                                
                                                <g:link  action="deleteSeguimientoTurnado" id="${seguimientoInstance[i].id}" params="['documento.id': documentoInstance?.id]" controller="seguimiento" onclick="return confirm('${message(code: '¿Está seguro que desea quitar este seguimiento?', default: '¿Está seguro que desea quitar este seguimiento?')}');" > <img src="${resource(dir:'images',file:'deleter.png')}" width="" height="" />    </g:link>
                                                </td>
