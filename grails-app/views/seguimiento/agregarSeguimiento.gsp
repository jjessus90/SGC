                ...
                <fieldset class="form">
                    ...
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                            ...
                            <div class="buttons">
                                <span class="button"><g:actionSubmit value="Agregar" action="saveSeguimiento"  class="save" /></span>
                                ...
                                <tbody>
                                    <g:each in="${seguimientoInstance}" status="i" var="seguimiento">
                                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                            ...
                                            <g:link  action="edit" id="${seguimientoInstance[i].id}" params="['documento.id': documentoInstance?.id, 'id': seguimientoInstance[i]?.id]" controller="seguimiento"> <img src="${resource(dir:'images',file:'editCat.png')}" width="" height="" />    </g:link>
                                            </td>
                                            <td>    

                                                
                                                <g:link  action="deleteSeguimiento" id="${seguimientoInstance[i].id}" params="['documento.id': documentoInstance?.id]" controller="seguimiento" onclick="return confirm('${message(code: '¿Está seguro que desea quitar este seguimiento?', default: '¿Está seguro que desea quitar este seguimiento?')}');" > <img src="${resource(dir:'images',file:'deleter.png')}" width="" height="" />    </g:link>
                                                </td>
