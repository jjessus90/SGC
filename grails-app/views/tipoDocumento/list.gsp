			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="tipoDocumento" title="${message(code: 'tipoDocumento.tipoDocumento.label', default: 'Tipo Documento')}" />
				...
				<g:each in="${tipoDocumentoInstanceList}" status="i" var="tipoDocumentoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tipoDocumentoInstance.id}">${fieldValue(bean: tipoDocumentoInstance, field: "tipoDocumento")}</g:link></td>
