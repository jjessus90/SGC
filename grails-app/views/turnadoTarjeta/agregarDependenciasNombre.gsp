                    ...
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                                ...
                                <table>
                                    ...
                                    <tr class="prop">
                                        ...
                                        <td valign="top" class="value ${hasErrors(bean: depositoInstance, field: 'grupo', 'errors')}">
                                            <g:textField name="numTarjeta"  maxlength="250" value="${tarjetaInformativaInstance?.numTarjeta}" onkeyup="" size="24px" readOnly="true"/>
                                            <g:hiddenField name="tarjetaInformativa.id" value="${tarjetaInformativaInstance?.id}" /></td>
                                        <g:hiddenField name="tarjetaInf" value="${tarjetaInformativaInstance?.id}" /></td>
                                    </tr>
                            ...
                            <div class="buttons">
                                ...
                                <g:if test="${tarjetaInformativaInstance}">                                    
                                    <g:link  action="show" id="${tarjetaInformativaInstance?.id}" params="['id': tarjetaInformativaInstance?.id]" title="Click mostrar detalle general de la tarjeta" controller="tarjetaInformativa"> <img src="${resource(dir:'images/skin',file:'editDocument.png')}" width="" height="" />    </g:link>
                                </g:if>
                            </div>
                            ...
                            <table style=" font-size: 11px;">
                                <thead>
                                    <tr>
                                        ...
                                        <g:sortableColumn property="nombre" title="${message(code: 'turnadoTarjeta.nombre.label', default: 'No')}" />

                                        <g:sortableColumn property="nombre" title="${message(code: 'turnadoTarjeta.nombre.label', default: 'Tarjeta')}" />

                                        <g:sortableColumn property="nombre" title="${message(code: 'turnadoTarjeta.nombre.label', default: 'Dependencia')}" />

                                       <g:sortableColumn property="responsable" title="${message(code: 'turnadoTarjeta.nombre.label', default: 'Persona')}" />
                                ...
                                <tbody>
                                    <g:each in="${turnadoTarjetaInstance}" status="i" var="turnado">
                                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                            ...
                                            <td>${turnadoTarjetaInstance[i]?.tarjetaInformativa?.numTarjeta?.encodeAsHTML()}</td>
                                            ...
                                            <td>    
                                                ...
                                                <g:link  action="deleteDep" id="${turnadoTarjetaInstance[i].id}" params="['tarjetaInformativa.id': tarjetaInformativaInstance?.id]" controller="turnadoTarjeta" onclick="return confirm('${message(code: '¿Está seguro que desea quitar esta dependencia?', default: '¿Está seguro que desea quitar esta dependencia?')}');" > <img src="${resource(dir:'images',file:'deleter.png')}" width="" height="" />    </g:link>
                                                </td>
